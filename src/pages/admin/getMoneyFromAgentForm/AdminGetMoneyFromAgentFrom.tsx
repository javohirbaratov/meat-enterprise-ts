...
const initialValues: IAdminGetMoneyFromAgentAdd = {
  zakup_id: "",
  summa: "",
  izoh: "",
};

const validationSchema = yup.object<IAdminGetMoneyFromAgentAdd>().shape({
...
const AdminGetMoneyFromAgentFrom: React.FC = () => {
  // Navigate
  ...
  // Submit
  const handleSubmit = async (values: IAdminGetMoneyFromAgentAdd) => {
...
export default AdminGetMoneyFromAgentFrom;
